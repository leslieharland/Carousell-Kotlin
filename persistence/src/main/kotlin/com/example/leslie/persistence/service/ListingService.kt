...
interface ListingService {
  ...
  /*  @POST("p/search")
    ...
    @GET("p/search")
    fun getListings(@Query("title") query: String): Call<List<ListingResponse>>

    @GET("p/user/{id}")
    fun getLikedListings(@Query("id") userId: Long): Call<List<ListingResponse>>

    @POST("p")
    fun postListing(@Body listing: Listing) : Call<ListingResponse>

    @GET("p/{id}/")
    fun getSingleListing(@Path("id") id: Int): Call<ListingResponse>

    @PUT("p/{id}/")
    fun updateListing(@Path("id") id: Int, @Body listing: ListingResponse): Call<ListingResponse>

    @DELETE("p/{id}/")
    fun deleteListing(@Path("id") id: Int): Call<Void>
    /**
     * Companion object for the factory
     */
    companion object Factory {
        fun create(): ListingService {
